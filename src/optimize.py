...
def optimize(content_targets, style_target, content_weight, style_weight,
    ...
    print('optimizeeeeeee content_targets', len(content_targets))
    print('optimizeeeeeee content_weight', content_weight)
    print('optimizeeeeeee style_weight', style_weight)

    style_features = {}

    batch_shape = (batch_size, 256, 256, 3)
    style_shape = (1,) + style_target.shape
    print('style_shapeeeeeeee', style_shape)
        ...
        for epoch in range(epochs):
            ...
            while iterations * batch_size < num_examples:
                ...
                for j, img_p in enumerate(content_targets[curr:step]):
                    X_batch[j] = get_img(
                        img_p, (256, 256, 3)).astype(np.float32)
